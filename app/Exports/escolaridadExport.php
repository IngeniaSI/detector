...
class escolaridadExport implements FromCollection, WithTitle, WithHeadings,WithStyles, ShouldAutoSize
{

    public function collection()
    {
        $rolesEstructura = ['SIN ESTUDIOS', 'PRIMARIA', 'SECUNDARIA', 'PREPARATORIA', 'UNIVERSIDAD', 'MAESTRA', 'DOCTORADO'];

        return collect($rolesEstructura)->map(function ($rol) {
            return ['Escolaridad' => $rol];
        });
    }
