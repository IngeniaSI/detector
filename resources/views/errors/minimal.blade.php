                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h4 class="text-center font-weight-light my-4">@yield('code') | @yield('message')</h4></div>
                                    
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="/iniciar-sesion/">⏎ Regresar al Inicio</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
